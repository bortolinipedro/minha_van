...
class _DriverProfileState extends State<DriverProfile> {
  final TextEditingController _nameController = TextEditingController(text: 'Motorista');
  final TextEditingController _phoneController = TextEditingController(text: '(31) 9 2222-2222');
  ...
  void _onItemTapped(int index) {
    ...
    if (index == 0) {
      Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(builder: (context) => const GroupsList()),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Texto simplificado "Perfil"
            Text('Perfil', style: AppTextStyles.listSubheading),
